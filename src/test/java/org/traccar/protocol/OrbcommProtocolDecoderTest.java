...
/**
 * Tests for the Orbcomm Protocol Decoder.
...
public class OrbcommProtocolDecoderTest extends ProtocolTest {
     ...
     * This test is designed for the microservices architecture where protocols publish messages to brokers.
     */
    @Test
    @Tag("microservice")
    public void testDecodeWithMessageBroker() throws Exception {
        var decoder = injectWithMessageBroker(new OrbcommProtocolDecoder(null));

        // Test with a position message
        verifyPositionWithBroker(decoder, response(
                buffer("{\"ErrorID\":0,\"NextStartUTC\":\"2022-02-17 08:44:45\",\"Messages\":[{\"ID\":10343663424,\"MessageUTC\":\"2022-02-17 08:44:45\",\"ReceiveUTC\":\"2022-02-17 08:44:45\",\"SIN\":126,\"MobileID\":\"01452955SKYB444\",\"Payload\":{\"Name\":\"MovingIntervalSat\",\"SIN\":126,\"MIN\":22,\"Fields\":[{\"Name\":\"Latitude\",\"Value\":\"727668\"},{\"Name\":\"Longitude\",\"Value\":\"902276\"},{\"Name\":\"Speed\",\"Value\":\"0\"},{\"Name\":\"Heading\",\"Value\":\"361\"},{\"Name\":\"EventTime\",\"Value\":\"1645087473\"}]},\"RegionName\":\"EMEARB6\",\"OTAMessageSize\":16,\"CustomerID\":0,\"Transport\":1,\"MobileOwnerID\":60003097}]}")));
    }

    /**
     * Tests cross-service boundary handling.
     * This test verifies that the protocol decoder correctly handles messages that cross service boundaries.
     */
    @Test
    @Tag("integration")
    public void testCrossServiceBoundaries() throws Exception {
        ...
        // Test with a position message that would cross service boundaries
        verifyPositionWithBroker(decoder, response(
                buffer("{\"ErrorID\":0,\"NextStartUTC\":\"2022-02-17 08:44:45\",\"Messages\":[{\"ID\":10343663424,\"MessageUTC\":\"2022-02-17 08:44:45\",\"ReceiveUTC\":\"2022-02-17 08:44:45\",\"SIN\":126,\"MobileID\":\"01452955SKYB444\",\"Payload\":{\"Name\":\"MovingIntervalSat\",\"SIN\":126,\"MIN\":22,\"Fields\":[{\"Name\":\"Latitude\",\"Value\":\"727668\"},{\"Name\":\"Longitude\",\"Value\":\"902276\"},{\"Name\":\"Speed\",\"Value\":\"0\"},{\"Name\":\"Heading\",\"Value\":\"361\"},{\"Name\":\"EventTime\",\"Value\":\"1645087473\"}]},\"RegionName\":\"EMEARB6\",\"OTAMessageSize\":16,\"CustomerID\":0,\"Transport\":1,\"MobileOwnerID\":60003097}]}")));

        // In a real implementation, we would verify that the position was correctly processed across service boundaries
        // This might involve checking that the position was published to the correct topics/queues,
        // and that downstream services processed it correctly
    }
}