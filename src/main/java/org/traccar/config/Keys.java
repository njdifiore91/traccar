...
public final class Keys {
    ...
    /**
     * Enable service discovery for dynamic handler resolution.
     */
    public static final ConfigKey<Boolean> SERVICE_DISCOVERY_ENABLED = new BooleanConfigKey(
     ...
     */
    public static final ConfigKey<Boolean> SERVICE_DISCOVERY_REGISTER = new BooleanConfigKey(
    ...
    /**
     * Service port for registration with service discovery.
     */
    public static final ConfigKey<Integer> SERVICE_DISCOVERY_SERVICE_PORT = new IntegerConfigKey(
            "service.discovery.servicePort",
            List.of(KeyType.CONFIG));
