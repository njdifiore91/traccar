...
/**
 * Abstract geolocation provider that handles HTTP POST requests to external geolocation services.
 * This class provides common functionality for services that accept a Network object as JSON
 * and return location information in a standard format.
 */
public class UniversalGeolocationProvider implements GeolocationProvider {
    ...
    /**
     * Constructs a new UniversalGeolocationProvider.
     *
     * @param client the HTTP client to use for requests
     * @param url    the base URL of the geolocation service
     * @param key    the API key for the geolocation service
     */
