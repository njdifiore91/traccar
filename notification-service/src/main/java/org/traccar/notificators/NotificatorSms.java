...
public class NotificatorSms extends Notificator {
    ...
    public NotificatorSms(
            SmsManager smsManager, NotificationFormatter notificationFormatter, 
            StatisticsManager statisticsManager, NotificatorCircuitBreaker circuitBreaker) {
    ...
    public void send(User user, NotificationMessage message, Event event, Position position) throws MessageException {
        // Use circuit breaker to protect against SMS service failures
        circuitBreaker.executeNotification(this, user, message, event, position);
    }
    
    /**
     * Internal method to send notification through SMS service.
