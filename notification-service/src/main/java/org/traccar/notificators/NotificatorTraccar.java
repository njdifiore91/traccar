...
public class NotificatorTraccar extends Notificator {
    ...
    public NotificatorTraccar(
            ...
            Storage storage, CacheManager cacheManager, NotificatorCircuitBreaker circuitBreaker) {
    ...
    public void send(User user, NotificationMessage shortMessage, Event event, Position position) throws MessageException {
        // Use circuit breaker to protect against Traccar API failures
        circuitBreaker.executeNotification(this, user, shortMessage, event, position);
    }
    
    /**
     * Internal method to send notification through Traccar API.
