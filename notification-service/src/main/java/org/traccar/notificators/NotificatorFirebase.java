...
public class NotificatorFirebase extends Notificator {
    ...
    public NotificatorFirebase(
            ...
            Storage storage, CacheManager cacheManager, NotificatorCircuitBreaker circuitBreaker) throws IOException {
    ...
    public void send(User user, NotificationMessage message, Event event, Position position) throws MessageException {
        // Use circuit breaker to protect against Firebase service failures
        circuitBreaker.executeNotification(this, user, message, event, position);
    }
    
    /**
     * Internal method to send notification through Firebase.
