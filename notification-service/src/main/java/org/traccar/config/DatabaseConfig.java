...
/**
 * Database configuration for the Notification Service.
 * Configures database connections, connection pooling, transaction management,
 * health indicators, and database migrations for notification settings and delivery status.
 */
@Configuration
...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        ...
        hikariConfig.setPoolName("notification-service-db-pool");
    ...
    public SpringLiquibase liquibase(DataSource dataSource) {
        ...
        liquibase.setContexts("notification-service");
        return liquibase;
    }
}